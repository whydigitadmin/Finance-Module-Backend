...
@Entity
@Table(name = "chargercostdebitnote")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class ChargerCostDebitNoteVO {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "chargercostdebitnotegen")
	@SequenceGenerator(name = "chargercostdebitnotegen", sequenceName = "chargercostdebitnoteseq", initialValue = 1000000001, allocationSize = 1)
	@Column(name = "chargercostdebitnoteid")
	private Long id;
